...
if (isset($_REQUEST['nameupdate'])) {
    if ($_REQUEST['rName'] == "") {
        ...
        if ($conn->query($sql) == TRUE) {
            $passmsg = '<div class="alert alert-success col-sm-6 mt-2" role="alert">Updated Succesfully</div>';
        } else {
            $passmsg = '<div class="alert alert-danger col-sm-6 mt-2" role="alert">Updated Error</div>';
        }
    }
}
?>
