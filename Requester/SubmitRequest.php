...
<div class="col-sm-9 col-md-10 mt-5"> <!-- start 2nd column Service Request-->
<form class= "mx-5" action="" method="POST">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-2">
        ...
        <input type="text" class="form-control" id="inputZip" maxlength="06" name="requesterzip" onkeypress="isInputNumber(event)">
      </div>
    </div>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-2">
        ...
        <input type="text" class="form-control" id="inputMobile" name="requestermobile" maxlength="10" onkeypress="isInputNumber(event)">
      </div>
      <div class="form-group col-md-2">
        <label for="inputDate">Date</label>
        <input type="date" class="form-control" id="inputDate" name="requestdate" max="2022-09-12">
      </div>
    </div>
...
</div><!--  2nd column end Service request-->



<!-- script for accepting nos -->
